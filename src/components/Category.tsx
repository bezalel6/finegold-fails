      ...
      <Card>
        ...
        <Box className="oneline">
          <Typography component={"span"} fontWeight={700} fontSize={25}>
            ...
            <Typography
              component={"span"}
              className={"rarity " + Rarity[category.rarity].toLowerCase()}
              fontSize={20}
              fontWeight={600}
            >
        ...
        <div data-size={calcIconSizeCategory(arr.length)} className="fails">
          {arr}
        </div>
      </Card>
    </Box>
