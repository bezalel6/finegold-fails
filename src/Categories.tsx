...
export const f3ConfuseOnTime: CategoryInterface = {
  ...
  explanation:
    "your opponent must've calculated every reasonable move. naturally, f3 wasn't one of them. when you played it you confused them so much they flagged.",
  rarity: Rarity.Legendary,
  outerCategory: F3Outer,
...
export const f3Drew: CategoryInterface = {
  name: "F3 and drew",
  explanation:
    "you learned a bad lesson. you managed to squeeze a draw after playing f3",
  rarity: Rarity.Epic,
  outerCategory: F3Outer,
